...
export type GetAllSlugsLessonsQueryVariables = Exact<{ [key: string]: never; }>;


export type GetAllSlugsLessonsQuery = { __typename?: 'Query', lessons: Array<{ __typename?: 'Lesson', slug: string }> };
...
export const GetAllSlugsLessonsDocument = gql`
  ...
  lessons {
    ...
    `;
export type GetAllSlugsLessonsProps<TChildProps = {}, TDataName extends string = 'data'> = {
      [key in TDataName]: ApolloReactHoc.DataValue<GetAllSlugsLessonsQuery, GetAllSlugsLessonsQueryVariables>
    } & TChildProps;
export function withGetAllSlugsLessons<TProps, TChildProps = {}, TDataName extends string = 'data'>(operationOptions?: ApolloReactHoc.OperationOption<
  TProps,
  GetAllSlugsLessonsQuery,
  GetAllSlugsLessonsQueryVariables,
  GetAllSlugsLessonsProps<TChildProps, TDataName>>) {
    return ApolloReactHoc.withQuery<TProps, GetAllSlugsLessonsQuery, GetAllSlugsLessonsQueryVariables, GetAllSlugsLessonsProps<TChildProps, TDataName>>(GetAllSlugsLessonsDocument, {
      alias: 'getAllSlugsLessons',
      ...operationOptions
    });
};

/**
 * __useGetAllSlugsLessonsQuery__
 *
 * To run a query within a React component, call `useGetAllSlugsLessonsQuery` and pass it any options that fit your needs.
 * When your component renders, `useGetAllSlugsLessonsQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useGetAllSlugsLessonsQuery({
 *   variables: {
 *   },
 * });
 */
export function useGetAllSlugsLessonsQuery(baseOptions?: Apollo.QueryHookOptions<GetAllSlugsLessonsQuery, GetAllSlugsLessonsQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<GetAllSlugsLessonsQuery, GetAllSlugsLessonsQueryVariables>(GetAllSlugsLessonsDocument, options);
      }
export function useGetAllSlugsLessonsLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GetAllSlugsLessonsQuery, GetAllSlugsLessonsQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<GetAllSlugsLessonsQuery, GetAllSlugsLessonsQueryVariables>(GetAllSlugsLessonsDocument, options);
        }
export type GetAllSlugsLessonsQueryHookResult = ReturnType<typeof useGetAllSlugsLessonsQuery>;
export type GetAllSlugsLessonsLazyQueryHookResult = ReturnType<typeof useGetAllSlugsLessonsLazyQuery>;
export type GetAllSlugsLessonsQueryResult = Apollo.QueryResult<GetAllSlugsLessonsQuery, GetAllSlugsLessonsQueryVariables>;
